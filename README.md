...
PyLox is considered complete (chapter 13 of the book completed). Currently it's coed is being simplified and optimized. Also, there is a plan to add a number of native functions and (possibly) modify the REPL to make it more comfortable to use.
